...
public class TextMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        tv.setTextColor(MyApplication.getContext().getResources().getColor(isSelf() ? R.color.im_text_color : R.color.im_text_color));
    ...
    public CharSequence getSummary() {
        ...
        if (!TextUtils.isEmpty(value)) {
            return EmoticonUtil.getEmotionSpannable(value);
        }
        return value;
    }
