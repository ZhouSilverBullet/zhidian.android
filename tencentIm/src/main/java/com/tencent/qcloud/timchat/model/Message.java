...
//        viewHolder.systemMessage.setText(TimeUtil.getWeixinShowTime0(date));
    ...
    public void setHasTime(TIMMessage message) {
        ...
        hasTime = this.message.timestamp() - message.timestamp() > 60;
    }
    ...
    public String getSenderName() {
        if (message.getMsg() != null && message.getMsg().getSenderProfile() != null) {
            com.tencent.imcore.FriendProfile senderProfile = message.getMsg().getSenderProfile();
            byte[] sNickname = senderProfile.getSNickname();
            byte[] sRemark = senderProfile.getSRemark();
            String remark = new String(sRemark);
            String nickname = new String(sNickname);
            Log.e(TAG, "remark : " + remark + " nickname : " + nickname);
