...
public class ApplyExamineListAdapter extends BaseQuickAdapter<ApplyListBean.DataBean.ApplyBean, BaseViewHolder> {
    ...
    public static final int PARENT_LEAVE = 21; //家长请假
    public static final int PARENT_VISIT = 22; //家长拜访
    ...
    public ApplyExamineListAdapter(int layoutResId) {
        super(layoutResId);
    }
...
//                    handleStartAndEndDate(statusText, titleValue, item);
                ...
                case YEAR_UNBUNDING_PHONE:
                    ...
                    break;
                case PARENT_LEAVE: //家长请假
                    handleApprovalTitleView(titleText, item.getStudent_name() + "家长", LeaveUtil.getParentName(item.getLeave_type()));
                    handleStartAndEndDate(statusText, titleValue, item);
                    break;
                case PARENT_VISIT: //家长拜访
                    handleApprovalTitleView(titleText, item.getStudent_name() + "家长", "拜访");
                    statusText.setText("时间：" + DateUtil.getApplyListLeaveCardTime(item.getVisit_time()));
                    break;
            }
