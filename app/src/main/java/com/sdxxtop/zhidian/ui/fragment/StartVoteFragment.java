...
public class StartVoteFragment extends BaseFragment implements XListView.IXListViewListener, AdapterView.OnItemClickListener{
    @BindView(R.id.tv_noresult)
    TextView tvNoresult;
    @BindView(R.id.lv_vote)
    XListView lvVote;

    private List<VoteIndexBean.DataEntity.VoteEntity> listStartVote = new ArrayList<>();
    private ShowVoteAdapter showVoteAdapter;
    private VoteIndexBean voteIndexBean;

    @Override
    protected int getFragmentView() {
        return R.layout.fragment_vote_start;
    }

    @Override
    protected void initData() {
        showVoteAdapter = new ShowVoteAdapter(mContext, listStartVote);
...
//                        listStartVote.add(i,voteIndexBean.getData().getVote().get(i));
//                    }
//                }else {
//                    listStartVote.addAll(voteIndexBean.getData().getVote());
//                }
