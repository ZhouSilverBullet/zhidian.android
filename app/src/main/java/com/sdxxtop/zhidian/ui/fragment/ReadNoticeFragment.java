...
public class ReadNoticeFragment extends BaseFragment{
    ...
    private List<NoticeDataBean.DataBean.NoticeBean> listRead = new ArrayList<>();
    private List<NoticeDataBean.DataBean.NoticeBean> listNoRead = new ArrayList<>();
