...
public class DownloadDialog {
    ...
    public DownloadDialog(Context context, AppInitBean.DataEntity dataEntity, RxPermissions rxPermissions) {
        ...
        if (isShow()) {
            ...
            update.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!isUrl(apkUrl)) {
                        ToastUtil.show("apk的下载地址不正确，请稍后重试");
                        return;
                    }
