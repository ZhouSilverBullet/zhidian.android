...
public class FriendshipManagerPresenter {
    ...
    public FriendshipManagerPresenter(FriendshipMessageView messageView, FriendshipManageView manageView, FriendInfoView view3) {
        friendshipMessageView = messageView;
        friendshipManageView = manageView;
